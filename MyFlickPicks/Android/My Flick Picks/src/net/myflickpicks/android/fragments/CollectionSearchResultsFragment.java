...
public class CollectionSearchResultsFragment extends SherlockListFragment
...
public CollectionSearchResultsFragment(String query, GraphUser user)
{
	searchQuery = query;
	currentUser = user;
}
...
public void onListItemClick(final ListView l, View v, final int position, long id)
{
    ...
    builder.setTitle("Add a Flick").setMessage("Would you like to add this movie to your collection?")
	...
	protected Object doInBackground(Object... params) {
		// TODO Auto-generated method stub
			...
			try {
				...
				String website = "http://myflickpicks.net/php/db/addmovietocollection.php?UserID=" + currentUser.getId().replace(" ", "%20") + "&MovieTitle=" + ((String)params[0]).replace(" ", "%20");

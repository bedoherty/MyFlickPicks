...
public class FindWatchersFragment extends SherlockListFragment implements LoaderManager.LoaderCallbacks<List<String>> {
private String[] optionsArray = new String[]{"Airplane", "Dark Knight Rises", "Spaceballs"};
	...
	public FindWatchersFragment(String title, GraphUser user)
	{
		currentUser = user;
		movieTitle = title;
	}
	...
	{
		getActivity().setTitle("Friends Who Like " + movieTitle);
...
//		Create a new laundryloader
	//return new LaundryLoader(getActivity(), residenceHall);
		return new FindWatchersLoader(getActivity(), currentUser.getId(), currentUser, movieTitle);
	}
